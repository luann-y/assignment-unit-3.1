...
let favoriteFoods = ['Vietnamese', 'Thai', 'Italian']
...
// let lastAnimal = animalArray[animalArray - 1];
// let lastAnimal = (animalArray[animalArray.length-1]);
...
console.log('Added food to beginning of favorite foods', favoriteFoods);
